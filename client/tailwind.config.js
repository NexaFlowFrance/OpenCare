    ...
    theme: {
        ...
        extend: {
            ...
            fontFamily: {
                ...
                // Kiosk senior: police concue pour les basses visions (Braille Institute)
                kiosk: ['Atkinson Hyperlegible', 'Inter', 'system-ui', 'sans-serif'],
                // Alias de transition: les anciennes pages utilisaient font-serif
